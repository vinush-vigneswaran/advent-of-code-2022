...
#update map with best reward from each point
while not terminate:
    ...
    # print(curr_coord_score_dict)
    # print(valid_neighbours_coord_score_dict)
    # print(reward_map)
...
#result
print("Reward map:\n",reward_map)
result = reward_map[start_x, start_y]
result = highest_score - result[0]
print("Min steps\n", result)